...
public class ItemProduceAdapter1 extends BaseAdapter {

    private List<ProduceBean.ResultBean> datas;
    private Context context;
    // 构造器
    public ItemProduceAdapter1(Context context, List datas) {
        super();
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.item_produce1, null);
        ...
        if(resultBean.getState().equals("已完成")){
            holder.ztImage.setImageDrawable(context.getResources().getDrawable(R.drawable.y1));
            holder.zt.setTextColor(context.getResources().getColor(R.color.baogongcolor));
        }else if(resultBean.getState().equals("已报工")){
            holder.ztImage.setImageDrawable(context.getResources().getDrawable(R.drawable.y2));
            holder.zt.setTextColor(context.getResources().getColor(R.color.xiadacolor));
        }else if(resultBean.getState().equals("已下单")){
            holder.ztImage.setImageDrawable(context.getResources().getDrawable(R.drawable.y3));
            holder.zt.setTextColor(context.getResources().getColor(R.color.wanchengcolor));
        }
