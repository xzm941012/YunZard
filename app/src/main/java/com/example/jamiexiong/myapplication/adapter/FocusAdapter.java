...
public class FocusAdapter extends BaseAdapter {
    ...
    private List<FocusListBean.FoocusListItems> datas;
    private Context context;
    private RequestQueue mQueue;
    private String url = "http://"+ UrlUtil.url1+"/request?rname=i_plc.Page.mobile.machq.machAttention.machAttention";

    // 构造器
    public FocusAdapter(Context context, List<FocusListBean.FoocusListItems> datas) {
        super();
        this.datas = datas;
    ...
    @Override
    public FocusListBean.FoocusListItems getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.focus_device, null);
        ...
        final FocusListBean.FoocusListItems item = getItem(position);
        holder.name.setText(item.getName());
        holder.xh.setText(item.getCodes());
