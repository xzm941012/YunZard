...
@ContentView(R.layout.activity_detail_date)
public class ActivityDetailLineChart extends FragmentActivity {
    ...
    private void initData(){
        ...
        LineChartView chart = new LineChartView(ActivityDetailLineChart.this);
        chart.setLineChartData(data);
    }
