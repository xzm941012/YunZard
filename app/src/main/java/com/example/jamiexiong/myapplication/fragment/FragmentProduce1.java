...
import com.example.jamiexiong.myapplication.adapter.ItemProduceAdapter1;
 ...
 */
@ContentView(R.layout.fragment_produce2)
public class FragmentProduce1 extends BaseFragment {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(resultCode.getCode().equals("200")){
                    shLv.setAdapter(new ItemProduceAdapter1(getContext(),resultBeanList));
                }else{
    ...
    private void initLayout(){
        ...
        sp = getActivity().getSharedPreferences("produce",MODE_PRIVATE);
        String shareData = "";
        //List<String> skills = Arrays.asList(shareData.split(","));
        List<String> skills = gson.fromJson(sp.getString("produce",""),new TypeToken<List<String>>() {}.getType());
    ...
    private void getEvent(View view) {
        switch (view.getId()){
            case R.id.imageView58:
                if (!spinner.getPopupWindow().isShowing()) {
                    spinner.expand();
                } else {
                    spinner.collapse();
                }
